...
public class SuaNV extends AppCompatActivity {
    ...
    String manv, ten, email, tenpb, sdt, tt;
    int trangthai = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DB.updateNV(manv, tennv, tenPB, mail, gt, sdtNV, trangthai);
    ...
    void getAndSetIntendata(){
        if(getIntent().hasExtra("MaNV") && getIntent().hasExtra("Ten") && getIntent().hasExtra("TenPB")
                && getIntent().hasExtra("Email") && getIntent().hasExtra("SDT")){
